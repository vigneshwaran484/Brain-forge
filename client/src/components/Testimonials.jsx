                ...
                <div className="bento-grid">
                    ...
                    <div className="bento-card reveal reveal-delay-2">
                        <div className="bento-stat">
                            ...
                            <div className="bento-progress"><div className="bento-progress-bar"><div className="bento-progress-fill" style={{ width: '100%', background: 'var(--green)' }}></div></div></div>
                        </div>
                    </div>
                    <div className="bento-card tall reveal reveal-delay-1">
                        <div className="bento-quote">"</div>
                        <div className="bento-stars">★★★★★</div>
                    ...
                    <div className="bento-card reveal reveal-delay-3">
                        <div className="bento-stat">
                            ...
                            <div className="bento-stat-label">Competition-Ready Students</div>
                        </div>
                    </div>
                </div>
            </div>
